...
import { Box, Grid, Theme, Typography, styled, Container } from "@mui/material";
...
const ServiceH3 = styled(Typography)(({ theme }) => ({
  fontSize: "2rem",
  fontWeight: 500,
}));
const ServiceH2 = styled(Typography)(({ theme }) => ({
  fontSize: "2.5rem",
  fontWeight: 600,
}));
...
const ServicesOffered: FC<ServicesOfferedProps> = (props) => {
  return (
    <>
      <MainBox>
        <ServiceH3 variant="h3" color="initial">
          WHAT WE CAN DO FOR YOU
        </ServiceH3>
        <ServiceH2 variant="h2" color="initial">
